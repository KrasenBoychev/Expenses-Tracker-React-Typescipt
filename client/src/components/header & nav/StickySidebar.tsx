export default function StickySidebar() {
  ...
  dark:bg-neutral-800 dark:border-neutral-700"
            ...
            >
              ...
              >
                ...
                <li className="hs-accordion" id="dropdown-accordion">
                  <button
                    type="button"
                    className="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:text-neutral-200 hs-scrollspy-active:bg-gray-100 dark:hs-scrollspy-active:bg-neutral-700"
                    aria-expanded="true"
      ...
      {/* <!-- Content --> */}
      <div className="lg:ps-65">
        <div className="min-h-300 p-4 md:p-8">
          {/* <!-- your content goes here ... --> */}

          {/* <!-- Content --> */}
          <div id="scrollspy" className="space-y-10 md:space-y-16">
            <div id="dashboard" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                Dashboard
              </h2>
            </div>

            <div id="users" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                Users
              </h2>
            </div>

            <div id="account" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                Account
              </h2>
            </div>

            <div id="projects" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                Projects
              </h2>
            </div>

            <div id="calendar" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                Calendar
              </h2>
            </div>

            <div id="documentation" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                Documentation
              </h2>
            </div>

            <div id="first" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                First
              </h2>
            </div>

            <div id="second" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                Second
              </h2>
            </div>

            <div id="third" className="min-h-100 scroll-mt-24">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-white">
                Third
              </h2>
            </div>
